...
class _MainEntranceTilesWorkSummaryState extends State<MainEntranceTilesWorkSummary> {
  final MainEntranceTilesWorkViewModel mainEntranceTilesWorkViewModel = Get.put(MainEntranceTilesWorkViewModel());
        ...
        child: Column(
          children: [
            ...
            Obx(() {
              ...
              // Filter the data
              final filteredData = mainEntranceTilesWorkViewModel.allEntrance.where((entry) {
                ...
                final statusMatch = _status == null ||
                    (entry.main_entrance_tiles_work_comp_status != null &&
                        entry.main_entrance_tiles_work_comp_status!.toLowerCase().contains(_status!.toLowerCase()));
                ...
                child: DataTable(
                  ...
                  rows: filteredData.map((entry) {
                    ...
                    return DataRow(cells: [
                      ...
                      DataCell(Text(entry.main_entrance_tiles_work_comp_status ?? '')), // Null check for status
