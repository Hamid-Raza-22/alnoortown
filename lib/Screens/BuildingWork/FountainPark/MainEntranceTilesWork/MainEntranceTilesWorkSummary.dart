...
class _MainEntranceTilesWorkSummaryState extends State<MainEntranceTilesWorkSummary> {
  MainEntranceTilesWorkViewModel mainEntranceTilesWorkViewModel = Get.put(
      MainEntranceTilesWorkViewModel());
            ...
            child: DataTable(
              ...
              rows: mainEntranceTilesWorkViewModel.allEntrance.map((entry) {
                ...
                String startDate = entry.startDate != null
                    ...
                    entry.startDate!) : ''; // Show empty string if null
                ...
                return DataRow(cells: [
                  ...
                  DataCell(Text(entry.mainEntranceTilesWorkCompStatus ?? '')),
