            ...
            Obx(() {
              ...
              final filteredData = plantationWorkViewModel.allPlant.where((entry) {
                ...
                final statusMatch = _status == null ||
                    (entry.plantationCompStatus != null &&
                        entry.plantationCompStatus!.toLowerCase().contains(_status!.toLowerCase()));
                ...
                child: DataTable(
                  ...
                  rows: filteredData.map((entry) {
                    ...
                    return DataRow(cells: [
                      ...
                      DataCell(Text(entry.plantationCompStatus ?? '')), // Null check for status
