...
class _PlantationWorkSummaryState extends State<PlantationWorkSummary> {
  final PlantationWorkViewModel plantationWorkViewModel = Get.put(PlantationWorkViewModel());
        ...
        child: Column(
          children: [
            ...
            Obx(() {
              ...
              // Filter the data
              final filteredData = plantationWorkViewModel.allPlant.where((entry) {
                ...
                final statusMatch = _status == null ||
                    (entry.plantation_comp_status != null &&
                        entry.plantation_comp_status!.toLowerCase().contains(_status!.toLowerCase()));
                ...
                child: DataTable(
                  ...
                  rows: filteredData.map((entry) {
                    ...
                    return DataRow(cells: [
                      ...
                      DataCell(Text(entry.plantation_comp_status ?? '')), // Null check for status
