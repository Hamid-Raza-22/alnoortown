            ...
            Obx(() {
              ...
              final filteredData = mudFillingWorkViewModel.allMud.where((entry) {
                ...
                final statusMatch = _status == null ||
                    (entry.mudFillingCompStatus != null &&
                        entry.mudFillingCompStatus!.toLowerCase().contains(_status!.toLowerCase()));
                ...
                child: DataTable(
                  ...
                  rows: filteredData.map((entry) {
                    ...
                    return DataRow(cells: [
                      ...
                      DataCell(Text(entry.totalDumpers ?? '')), // Null check for total dumpers
