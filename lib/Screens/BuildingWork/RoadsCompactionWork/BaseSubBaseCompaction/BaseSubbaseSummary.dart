...
import '../../../../Models/BuildingWorkModels/RoadsCompactionWork/base_sub_base_compaction_model.dart';
...
class _BaseSubBaseCompactionSummaryState extends State<BaseSubBaseCompactionSummary> {
  ...
  List<BaseSubBaseCompactionModel> getFilteredData() {
    return baseSubBaseCompactionViewModel.allSubBase.where((entry) {
          ...
          children: [
            ...
            Expanded(
              child: Obx(() {
                ...
                List<BaseSubBaseCompactionModel> filteredData = getFilteredData();
                  ...
                  child: DataTable(
                    ...
                    rows: filteredData.map((entry) {
                      ...
                      return DataRow(cells: [
                        ...
                        DataCell(Text(entry.baseSubBaseCompStatus ?? '')),
