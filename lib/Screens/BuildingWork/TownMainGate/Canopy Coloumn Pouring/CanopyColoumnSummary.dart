...
class CanopyColoumnsummary extends StatefulWidget {
  @override
  _CanopyColoumnsummaryState createState() => _CanopyColoumnsummaryState();
}

class _CanopyColoumnsummaryState extends State<CanopyColoumnsummary> {
          ...
          children: [
            ...
            Expanded(
              child: Obx(() {
                ...
                var filteredData = canopyColumnPouringViewModel.allCanopy.where((entry) {
