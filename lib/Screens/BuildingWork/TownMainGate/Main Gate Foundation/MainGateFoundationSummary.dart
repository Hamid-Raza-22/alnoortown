...
class MainGateFoundationSummary extends StatefulWidget {
  const MainGateFoundationSummary({super.key});

  @override
  _MainGateFoundationSummaryState createState() => _MainGateFoundationSummaryState();
}

class _MainGateFoundationSummaryState extends State<MainGateFoundationSummary> {
          ...
          children: [
            ...
            Expanded(
              child: Obx(() {
                ...
                var filteredData = mainGateFoundationWorkViewModel.allMainFoundation.where((entry) {
