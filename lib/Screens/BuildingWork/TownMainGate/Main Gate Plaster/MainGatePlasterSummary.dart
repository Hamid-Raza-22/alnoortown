...
class MainGatePlasterSummary extends StatefulWidget {
  @override
  _MainGatePlasterSummaryState createState() => _MainGatePlasterSummaryState();
}

class _MainGatePlasterSummaryState extends State<MainGatePlasterSummary> {
          ...
          children: [
            ...
            Expanded(
              child: Obx(() {
                ...
                var filteredData = mgPlasterWorkViewModel.allMgPlaster.where((entry) {
