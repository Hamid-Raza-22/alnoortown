        ...
        child: Column(
          children: [
            ...
            Obx(() {
              ...
              // Filter the data
              final filteredData = roadsEdgingWorkViewModel.allRoadEdging.where((entry) {
                ...
                final statusMatch = _status == null || (entry.roads_edging_comp_status != null && entry.roads_edging_comp_status!.toLowerCase().contains(_status!.toLowerCase()));
