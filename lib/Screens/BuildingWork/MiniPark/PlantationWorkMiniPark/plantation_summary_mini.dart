...
class _Plantation_Mini_SummaryState extends State<Plantation_Mini_Summary> {
  ...
  List<dynamic> getFilteredData() {
    if (fromDate == null && toDate == null) {
      return mpPlantationWorkViewModel.allMpPlant;
    }

    return mpPlantationWorkViewModel.allMpPlant.where((entry) {
                      ...
                      rows: filteredData.map((entry) {
                        ...
                        return DataRow(
                          cells: [
                            ...
                            DataCell(Text(entry.mpPCompStatus ?? '', style: const TextStyle(fontSize: 12))),
