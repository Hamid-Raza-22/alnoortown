...
class _MPMudFillingSummaryState extends State<MPMudFillingSummary> {
  final MiniParkMudFillingViewModel miniParkMudFillingViewModel = Get.put(MiniParkMudFillingViewModel());
  ...
  List<dynamic> getFilteredData() {
    if (fromDate == null && toDate == null) {
      return miniParkMudFillingViewModel.allMpMud;
    }

    return miniParkMudFillingViewModel.allMpMud.where((entry) {
