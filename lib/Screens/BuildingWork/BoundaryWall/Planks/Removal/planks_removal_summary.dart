...
class PlanksRemovalSummary extends StatefulWidget {
  @override
  PillarsFixingSummaryState createState() => PillarsFixingSummaryState();
}

class PillarsFixingSummaryState extends State<PlanksRemovalSummary> {
...
PlanksRemovalViewModel planksRemovalViewModel=Get.put(PlanksRemovalViewModel());
  ...
  void initState() {
    ...
    planksRemovalViewModel.fetchAllPlanksRemoval();
  }
          ...
          children: [
            FilterWidget(onFilter: (fromDate, toDate, block) {
              setState(() {
                ...
                planksRemovalViewModel.filterPlanksRemoval(filterFromDate, filterToDate, filterBlock);
              });
            }),
            Expanded(
              child: Obx(() {
                if (planksRemovalViewModel.allPlanksRemoval.isEmpty) {
                  return Center(
                    child: Column(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: SizedBox(
                      ...
                      child: GridView.builder(
                        ...
                        itemCount: planksRemovalViewModel.allPlanksRemoval.length * 5 + 5,
                        itemBuilder: (context, index) {
                          if (index < 5) {
                            ...
                            if (entryIndex < planksRemovalViewModel.allPlanksRemoval.length) {
                              final entry = planksRemovalViewModel.allPlanksRemoval[entryIndex];
                              final data = [
                                entry.block ?? 'N/A',
