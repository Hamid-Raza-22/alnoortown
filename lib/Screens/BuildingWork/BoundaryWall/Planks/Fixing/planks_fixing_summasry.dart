...
class PlanksFixingSummary extends StatefulWidget {
  @override
  PillarsFixingSummaryState createState() => PillarsFixingSummaryState();
}

class PillarsFixingSummaryState extends State<PlanksFixingSummary> {

  final PlanksFixingViewModel planksFixingViewModel = Get.put(PlanksFixingViewModel());
  ...
  void initState() {
    ...
    planksFixingViewModel.fetchAllPlanksFixing();
  }
          ...
          children: [
            FilterWidget(onFilter: (fromDate, toDate, block) {
              setState(() {
                ...
                planksFixingViewModel.filterPlanksFixing(filterFromDate, filterToDate, filterBlock);
              });
            }),
            Expanded(
              child: Obx(() {
                if (planksFixingViewModel.allPlanksFixing.isEmpty) {
                  return Center(
                    child: Column(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: SizedBox(
                      ...
                      child: GridView.builder(
                        ...
                        itemCount: planksFixingViewModel.allPlanksFixing.length * 5 + 5,
                        itemBuilder: (context, index) {
                          if (index < 5) {
                            ...
                            if (entryIndex < planksFixingViewModel.allPlanksFixing.length) {
                              final entry = planksFixingViewModel.allPlanksFixing[entryIndex];
                              final data = [
                                entry.block ?? 'N/A',
                                entry.no_of_planks ?? 'N/A',
