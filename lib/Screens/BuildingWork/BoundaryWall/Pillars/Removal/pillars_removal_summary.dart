...
import '../../../../../ViewModels/BuildingWorkViewModel/BoundaryWallViewModel/PillarsViewModel/pillars_removal_view_model.dart';
import '../../../../ReusableDesigns/filter_widget.dart';


class PillarsRemovalSummary extends StatefulWidget {
  @override
  PillarsFixingSummaryState createState() => PillarsFixingSummaryState();
}

class PillarsFixingSummaryState extends State<PillarsRemovalSummary> {
  final PillarsRemovalViewModel pillarsRemovalViewModel = Get.put(PillarsRemovalViewModel());
  ...
  void initState() {
    ...
    pillarsRemovalViewModel.fetchAllPillarsRemoval();
  }
          ...
          children: [
            FilterWidget(onFilter: (fromDate, toDate, block) {
              setState(() {
                ...
                pillarsRemovalViewModel.filterPillarsRemoval(filterFromDate, filterToDate, filterBlock);
              });
            }),
            Expanded(
              child: Obx(() {
                if (pillarsRemovalViewModel.allPillarsRemoval.isEmpty) {
                  return Center(
                    child: Column(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: SizedBox(
                      ...
                      child: GridView.builder(
                        ...
                        itemCount: pillarsRemovalViewModel.allPillarsRemoval.length * 5 + 5,
                        itemBuilder: (context, index) {
                          if (index < 5) {
                            ...
                            if (entryIndex < pillarsRemovalViewModel.allPillarsRemoval.length) {
                              final entry = pillarsRemovalViewModel.allPillarsRemoval[entryIndex];
                              final data = [
                                entry.block ?? 'N/A',
