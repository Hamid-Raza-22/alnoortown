...
class PlasterWorkSummary extends StatefulWidget {
  PlasterWorkSummary({super.key});

  @override
  _PlasterWorkSummaryState createState() => _PlasterWorkSummaryState();
}

class _PlasterWorkSummaryState extends State<PlasterWorkSummary> {
  final PlasterWorkViewModel plasterWorkViewModel = Get.put(PlasterWorkViewModel());
  ...
  void initState() {
    super.initState();
    plasterWorkViewModel.fetchAllPlaster();
  }
          ...
          children: [
            ...
            Expanded(
              child: Obx(() {
                ...
                final filteredData = plasterWorkViewModel.allPlaster.where((entry) {
                  // Filter by block
