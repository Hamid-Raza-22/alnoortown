...
class ShutteringWorkSummary extends StatefulWidget {
  ShutteringWorkSummary({super.key});

  @override
  _ShutteringWorkSummaryState createState() => _ShutteringWorkSummaryState();
}

class _ShutteringWorkSummaryState extends State<ShutteringWorkSummary> {
  ...
  void initState() {
    super.initState();
    shutteringWorkViewModel.fetchAllShutter();
  }
          ...
          children: [
            ...
            Expanded(
              child: Obx(() {
                ...
                final filteredData = shutteringWorkViewModel.allShutter.where((entry) {
                  // Filter by block
