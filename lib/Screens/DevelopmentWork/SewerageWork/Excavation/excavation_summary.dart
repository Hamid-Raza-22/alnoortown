...
class ExcavationSummary extends StatefulWidget {
  @override
  _ExcavationSummaryState createState() => _ExcavationSummaryState();
}

class _ExcavationSummaryState extends State<ExcavationSummary> {
  final ExcavationViewModel excavationViewModel = Get.put(ExcavationViewModel());
  DateTime? _fromDate;
  DateTime? _toDate;
  String? _block;
  ...
  void initState() {
    super.initState();
    excavationViewModel.fetchAllExa();
  }
          ...
          children: [
            ...
            Expanded(
              child: Obx(() {
                ...
                final filteredData = excavationViewModel.allExa.where((entry) {
                  // Filter by block
