...
class PipelyingSummary extends StatefulWidget {
  @override
  _PipelyingSummaryState createState() => _PipelyingSummaryState();
}

class _PipelyingSummaryState extends State<PipelyingSummary> {
  ...
  void initState() {
    super.initState();
    pipelineViewModel.fetchAllPipe();
  }
