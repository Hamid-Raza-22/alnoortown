...
class FoundationWorkSummary extends StatefulWidget {
  const FoundationWorkSummary({super.key});

  @override
  _PolesExcavationSummaryState createState() => _PolesExcavationSummaryState();
}

class _PolesExcavationSummaryState extends State<FoundationWorkSummary> {
  final PolesFoundationViewModel polesFoundationViewModel = Get.put(PolesFoundationViewModel());
  ...
  void initState() {
    super.initState();
    polesFoundationViewModel.fetchAllPoleFoundation();
  }
          ...
          children: [
            ...
            Expanded(
              child: Obx(() {
                ...
                final filteredData = polesFoundationViewModel.allPoleExa.where((entry) {
                  // Filter by block
                      ...
                      ...filteredData.map((entry) {
                        return Row(
                          children: [
                            ...
                            buildDataCell(entry.no_of_foundation ?? 'N/A'),
