          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => ElectricityWorkSummary(containerDataList: containerDataList), // Pass the data
                ),
              );
            },
          ),
...
class ElectricityWorkSummary extends StatelessWidget {
  final List<Map<String, dynamic>> containerDataList;

  const ElectricityWorkSummary({super.key, required this.containerDataList});
