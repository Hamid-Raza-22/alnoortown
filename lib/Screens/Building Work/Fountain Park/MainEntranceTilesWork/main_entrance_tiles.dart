...
class MainEntranceTilesWork extends StatefulWidget {
  const MainEntranceTilesWork({super.key});

  @override
  _MainEntranceTilesWorkState createState() => _MainEntranceTilesWorkState();
}
