...
class MainGatePlasterWork extends StatefulWidget {
  ...
  @override
  _MainGatePlasterWorkState createState() => _MainGatePlasterWorkState();
}

class _MainGatePlasterWorkState extends State<MainGatePlasterWork> {
  ...
  Future<void> _loadData() async {
    ...
    String? savedData = prefs.getString('MainGatePlasterDataList');
    if (savedData != null) {
      setState(() {
  ...
  Future<void> _saveData() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setString('MainGatePlasterDataList', json.encode(containerDataList));
  }
