...
class MainGateFoundationSummary extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    itemCount: mainGateFoundationWorkViewModel.allMainFoundation.length * 4 + 4, // Update this to 6 columns
    ...
    if (entryIndex < mainGateFoundationWorkViewModel.allMainFoundation.length) {
    final entry = mainGateFoundationWorkViewModel.allMainFoundation[entryIndex];
    final data = [
    entry.blockNo ?? 'N/A',
