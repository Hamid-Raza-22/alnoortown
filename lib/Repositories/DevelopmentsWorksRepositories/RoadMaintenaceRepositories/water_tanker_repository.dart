...
class WaterTankerRepository{
  ...
  Future<List<WaterTankerModel>> getTanker() async {
    ...
    List<Map> maps = await dbClient.query(
        ...
        columns: ['id', 'block_no', 'street_no', 'tanker_no','water_tanker_date','time','posted','user_id']
    );
    ...
    print('${Config.getApiUrlWaterTanker}$userId');
      List<dynamic> data = await ApiService.getData('${Config.getApiUrlWaterTanker}$userId');
      var dbClient = await dbHelper.db;
