...
class PolesExcavationRepository{
  ...
  Future<List<PolesExcavationModel>> getPolesExcavation() async {
    ...
    List<Map> maps = await dbClient.query(
        ...
        columns: ['id', 'block_no', 'street_no', 'no_of_excavation','poles_excavation_date','time','posted','user_id']
    );
  ...
  Future<void> fetchAndSavePolesExcavationData() async {
    List<dynamic> data = await ApiService.getData('${Config.getApiUrlPolesExcavation}$userId');
    var dbClient = await dbHelper.db;
