...
class DBHelper{
  ...
  _onCreate(Database db, int version) async {
    ...
    List<String> tableQueries = [
      ...
      "CREATE TABLE IF NOT EXISTS $tableNameManholes(id INTEGER PRIMARY KEY,blockNo TEXT, streetNo TEXT, noOfManholes TEXT,date TEXT,time TEXT)",
      ...
      "CREATE TABLE IF NOT EXISTS $tableNameLightWires(id INTEGER PRIMARY KEY,blockNo TEXT, lightWireWorkStatus TEXT,streetNo TEXT,totalLength TEXT,date TEXT,time TEXT)",
      "CREATE TABLE IF NOT EXISTS $tableNamePolesExcavation(id INTEGER PRIMARY KEY,blockNo TEXT, streetNo TEXT, noOfExcavation TEXT,date TEXT,time TEXT)",
      "CREATE TABLE IF NOT EXISTS $tableNamePoles(id INTEGER PRIMARY KEY,blockNo TEXT, streetNo TEXT, noOfPoles TEXT,date TEXT,time TEXT)",
      ...
      "CREATE TABLE IF NOT EXISTS $tableNameMonumentWork(id INTEGER PRIMARY KEY,startDate TEXT, expectedCompDate TEXT, monumentsWorkCompStatus TEXT,date TEXT,time TEXT)",
