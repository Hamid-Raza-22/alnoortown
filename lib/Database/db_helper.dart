...
class DBHelper {
  ...
  _onCreate(Database db, int version) async {
    ...
    List<String> tableQueries = [
      ...
      "CREATE TABLE IF NOT EXISTS $tableNameLogin(id INTEGER PRIMARY KEY,user_name TEXT,contact TEXT,cnic TEXT,image TEXT,address TEXT,user_id TEXT,city TEXT,password TEXT)",
    ];
