...
class DBHelper {
  ...
  _onCreate(Database db, int version) async {
    ...
    List<String> tableQueries = [
      ...
      "CREATE TABLE IF NOT EXISTS $tableNamePolesFoundation(id INTEGER PRIMARY KEY,block_no TEXT, street_no TEXT, no_of_foundation TEXT,poles_foundation_date TEXT,time TEXT,user_id TEXT, posted INTEGER DEFAULT 0)",
      ...
      "CREATE TABLE IF NOT EXISTS $tableNameShiftingWork(id INTEGER PRIMARY KEY,from_block TEXT, to_block TEXT, no_of_shift TEXT, details TEXT, shifting_work_date TEXT,time TEXT,user_id TEXT, posted INTEGER DEFAULT 0)",
      ...
      "CREATE TABLE IF NOT EXISTS $tableNameNewMaterials(id INTEGER PRIMARY KEY,block TEXT,sand TEXT, soil TEXT, base TEXT, sub_base TEXT,water_bound TEXT,other_material TEXT,other_material_value TEXT,new_material_date TEXT,time TEXT,user_id TEXT, posted INTEGER DEFAULT 0)",
      ...
      "CREATE TABLE IF NOT EXISTS $tableNameBaseSubBaseCompaction(id INTEGER PRIMARY KEY,block_no TEXT,working_hours TEXT, road_no TEXT, total_length TEXT, start_date TEXT, expected_comp_date TEXT, base_sub_base_comp_status TEXT,base_sub_base_compaction_date TEXT,time TEXT,user_id TEXT, posted INTEGER DEFAULT 0)",
      "CREATE TABLE IF NOT EXISTS $tableNameCompactionAfterWaterBound(id INTEGER PRIMARY KEY,block_no TEXT,working_hours TEXT, road_no TEXT, total_length TEXT, start_date TEXT, expected_comp_date TEXT, water_bound_comp_status TEXT,compaction_water_bound_date TEXT,time TEXT,user_id TEXT, posted INTEGER DEFAULT 0)",
      "CREATE TABLE IF NOT EXISTS $tableNameSandCompaction(id INTEGER PRIMARY KEY,block_no TEXT,working_hours TEXT, road_no TEXT, total_length TEXT, start_date TEXT, expected_comp_date TEXT,sand_comp_status TEXT,sand_compaction_date TEXT,time TEXT,user_id TEXT, posted INTEGER DEFAULT 0)",
      "CREATE TABLE IF NOT EXISTS $tableNameSoilCompaction(id INTEGER PRIMARY KEY,block_no TEXT,working_hours TEXT, road_no TEXT, total_length TEXT, start_date TEXT, expected_comp_date TEXT,  soil_comp_status TEXT,soil_compaction_date TEXT,time TEXT,user_id TEXT, posted INTEGER DEFAULT 0)",
