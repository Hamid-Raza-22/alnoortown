...
class DBHelper {
  ...
  _onCreate(Database db, int version) async {
    ...
    List<String> tableQueries = [
      ...
      "CREATE TABLE IF NOT EXISTS $tableNameSittingAreaWork(id INTEGER PRIMARY KEY,type_of_work TEXT,start_date TEXT, expected_comp_date TEXT,sitting_area_comp_status TEXT,sitting_area_date TEXT,time TEXT,user_id TEXT, posted INTEGER DEFAULT 0)",
      ...
      "CREATE TABLE IF NOT EXISTS $tableNameRoadsDetail(id INTEGER PRIMARY KEY,phase TEXT, block TEXT,street TEXT,length TEXT,user_id TEXT, road_type TEXT)",
      "CREATE TABLE IF NOT EXISTS $tableNameBlocksDetails(id INTEGER PRIMARY KEY, block TEXT,marla TEXT,user_id TEXT,plot_no TEXT)",
      "CREATE TABLE IF NOT EXISTS $tableNameLogin(id INTEGER PRIMARY KEY, user_id TEXT,user_name TEXT,contact TEXT,cnic TEXT,image TEXT,address TEXT,user_id TEXT,city TEXT,password TEXT)",
    ];
